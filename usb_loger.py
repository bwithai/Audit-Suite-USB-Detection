...
class RegisterDialog(QDialog):
    ...
    def initUI(self):
        ...
        header_label.setAlignment(Qt.AlignCenter)
        header_label.setFont(QFont("Arial", 30, QFont.Bold))
        header_pixmap = QPixmap('C:\\Office\\audit_suite\\usb_logo.jpg')
        header_pixmap = header_pixmap.scaled(700, 150, Qt.KeepAspectRatio)
    ...
    def register(self):
        ...
        if not crud.authenticate_as_admin(admin_username, admin_password, self.db):
...
class UserView(QDialog):
    ...
    def initUI(self):
        ...
        # login_button.clicked.connect(self.showTableView)
